...
class Zend_Validate_EmailAddress extends Zend_Validate_Abstract
{
    ...
    protected $_messageTemplates = array(
        ...
        self::INVALID_FORMAT     => "'' Por favor introduzca un email valido",
        self::INVALID_HOSTNAME   => "'%hostname%' Por favor introduzca un email valido'%value%'",
        self::INVALID_MX_RECORD  => "'%hostname%' Por favor introduzca un email valido'%value%'",
        self::INVALID_SEGMENT    => "'%hostname%' Por favor introduzca un email valido '%value%'",
